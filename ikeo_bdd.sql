...
--
-- Host: localhost:8081
-- Generation Time: Nov 23, 2020 at 08:49 AM
...
(2, 'Magasin', 'Bo Meuble', 'Place Vendôme', 'Paris', 1),
(3, 'Magasin', 'Mobel', 'Porte de Brandebourg ', 'Berlin', 2),
(5, 'Magasin', 'Tout A La Maison', 'Rue de la Bastille', 'Paris', 1),
(6, 'Magasin', 'Bo Meuble', 'Avenue des Trois Dragons', 'Barcelone', 3),
(7, 'Central d\'achat', 'The World Compagny', 'Oxford street', 'Londres', 4),
(8, 'Magasin', 'The Best Greatest Beautifulest Furniture', 'Coven Garden ', 'Londres', 4),
(9, 'Magasin', 'Tout à la maison', 'Place Terreaux', 'Lyon', 1),
(13, 'Magasin', 'Thomas', '17 rue Maria Chapdelaine', 'Brest', 1),
(14, 'Magasin', 'Casa Buena', 'Calle Calimuxo', 'Bilbao', 3);
...
('AXTD68', 'Tafto', 'Tutu de bain', 0),
('IGHF55', 'Knolgg', 'Canapé télescopique', 1),
('KUFS23', 'Michluv', 'Louche biface', 1),
...
('OANT12', 'Apfelgluck', 'Panier à chien (ou à chat) ', 1),
...
('OXFS12', 'Michluv', 'Louche biface', 1);
...
ALTER TABLE `produit_site`
  ...
  ADD CONSTRAINT `produit_site_ibfk_2` FOREIGN KEY (`id_produit`) REFERENCES `produits` (`id_produit`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
